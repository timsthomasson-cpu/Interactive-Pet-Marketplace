...
const ICON_MAP: Record<string, React.ComponentType<{ className?: string }>> = {
  "Control Accessibility": IconUsers,
  "Fall-Risk Profile": IconShieldCheck,
  ...
  "Visual Contrast / Visibility": IconSparkleClean,
};
...
const WHY_TOP_PICK_BULLETS = [
  { label: "Visual Contrast / Visibility", note: "Score of 5 — high contrast colours make it easy to see and locate." },
  { label: "Safety Risk", note: "No sharp edges, small pieces, or tip-over risk." },
  { label: "Size And Portability", note: "Compact and lightweight — easy to hold, carry, and store safely." },
  { label: "Control Accessibility", note: "Simple controls that don't require fine motor precision." },
];
      ...
      <section className="relative overflow-hidden bg-blue-100 py-8 sm:py-10">
        <div
          ...
          style={{
            backgroundImage: [
              ...
              "),",
              "url('/vision-challenges-hero.png')",
            ].join(" "),
        ...
        <div className="container-shell relative z-10">
          ...
          <h1 className="mt-1 text-4xl font-extrabold tracking-tight text-slate-900 sm:text-5xl">
            Best Pets for Seniors with Vision Challenges
          </h1>
          <p className="mt-2 max-w-2xl text-base font-medium leading-7 text-slate-700">
            Companion pets ranked for high visual contrast, safe handling, and audio feedback — ideal for seniors with low or impaired vision.
          </p>
      ...
      {topPick && (
        <section className="py-4 sm:py-5 bg-white">
          <div className="container-shell">
            ...
            <Link href="/best-pets-for-seniors-with-vision-challenges/scoring" className="mt-2 inline-flex items-center gap-1 text-sm font-semibold text-trust-600 underline underline-offset-4 hover:text-trust-800">
      ...
      <section className="pb-4 sm:pb-5 bg-white">
        <div className="container-shell">
          ...
          <div className="mt-4 border-t border-blue-200 pt-3 text-center">
            <Link href="/best-pets-for-seniors-with-vision-challenges/scoring" className="inline-flex items-center gap-1 text-sm font-semibold text-trust-600 underline underline-offset-4 hover:text-trust-800">
              Show detailed scoring results →
            </Link>
          </div>
        </div>
