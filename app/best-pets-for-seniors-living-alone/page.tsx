...
const WHY_TOP_PICK_BULLETS = [
  { label: "Emotional Comfort Potential", note: "Highest score for emotional engagement — designed to feel like a real companion." },
  { label: "Tactile Comfort", note: "Soft, realistic fur and warm weight make it comforting to hold and pet." },
  { label: "Safety Risk", note: "No choking hazards, sharp edges, or tip-over risk — safe for independent use." },
  { label: "Simplicity Of Use", note: "No apps, accounts, or subscriptions — turns on and responds immediately." },
];
          ...
          <div className="flex items-start gap-4">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-base font-medium leading-7 text-slate-700">
                Calming, easy-to-love companions ranked for emotional comfort, simplicity, and safety — ideal for seniors living independently.
              </p>
      ...
      {topPick && (
        <section className="py-4 sm:py-5 bg-white">
          <div className="container-shell">
            ...
            <Link href="/best-pets-for-seniors-living-alone/scoring" className="mt-2 inline-flex items-center gap-1 text-sm font-semibold text-trust-600 underline underline-offset-4 hover:text-trust-800">
      ...
      <section className="pb-4 sm:pb-5 bg-white">
        <div className="container-shell">
          ...
          <div className="mt-4 border-t border-purple-200 pt-3 text-center">
            <Link href="/best-pets-for-seniors-living-alone/scoring" className="inline-flex items-center gap-1 text-sm font-semibold text-trust-600 underline underline-offset-4 hover:text-trust-800">
              Show detailed scoring results →
            </Link>
          </div>
        </div>
