...
const ARTICLES = [
  {
    ...
    desc: "Small studies suggest that robotic companion pets may ease loneliness, depression and anxiety for some older adults. The evidence is encouraging, but still developing.",
  ...
  },
  {
    ...
    desc: "Interactive robotic pets can give children opportunities for nurturing play and companionship when a living animal isn't practical — but research hasn't established they match all the same benefits as real animals.",
