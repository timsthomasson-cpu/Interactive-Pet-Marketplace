    ...
    <PageShell>
      <section className="section-pad">
        <div className="container-shell">
          <div className="mb-8"><Link href="/best-for-loneliness" className="text-sm font-semibold text-trust-600 hover:underline">← Back to rankings</Link></div>
          <p className="eyebrow">Detailed Scoring</p>
          <h1 className="mt-2 text-2xl font-bold tracking-tight text-slate-900 sm:text-3xl">Best for Loneliness — Top 5 Results</h1>
