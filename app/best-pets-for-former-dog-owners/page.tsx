        ...
        <div className="container-shell">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <h1 className="mt-1 text-4xl font-extrabold tracking-tight text-slate-900 sm:text-5xl">Best Pets for Former Dog Owners</h1>
      ...
      <section className="py-4 sm:py-5 bg-white">
        <div className="container-shell">
          ...
          <div className="mt-4 border-t border-purple-200 pt-3 text-center">
            <Link href="/best-pets-for-former-dog-owners/scoring" className="text-sm font-semibold text-trust-600 underline underline-offset-4 hover:text-trust-800">Show detailed scoring results →</Link>
          </div>
        </div>
      </section>
    </PageShell>
