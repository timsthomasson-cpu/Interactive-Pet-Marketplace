...
export const SCORES: BestForScoreRow[] = [
  { slug: 'percy-1-1-robotic-companion-dog', score: 4.50, scorePercent: 100, price: 99.00, priceCategory: 'Budget Friendly', animalCategory: 'Dog', type: 'Fluffy Companion', movementLevel: 3, soundQuality: 4, visualContrast: 3 },
