...
export const ROWS: RankedRow[] = [
  {
    ...
    rating: '4.8', reviews: '13', overall: '4.5',
  ...
  },
  {
    ...
    rating: '4.3', reviews: '5,195', overall: '4.1',
    scores: { emotional: 5, realism: 3, recognizable: 5, simplicity: 5, sound: 3, tactile: 3, touch: 5 },
  },
  {
    rank: 3, manufacturer: 'Perfect Petzzz', product: 'Original Border Collie',
    priceCategory: 'Budget Friendly', animal: 'Dog', price: '$44.45',
    rating: '4.4', reviews: '441', overall: '2.8',
  ...
  },
  {
    ...
    rating: '4.1', reviews: '1,231', overall: '2.5',
  ...
  },
  {
    ...
    rating: '4.5', reviews: '346', overall: '2.4',
