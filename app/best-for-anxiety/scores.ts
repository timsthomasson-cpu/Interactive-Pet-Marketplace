...
export const SCORES: BestForScoreRow[] = [
  ...
  { slug: 'dj-furby', score: 3.55, scorePercent: 76, price: 50.11, priceCategory: 'Budget Friendly', animalCategory: 'Robot', type: 'Ai & Robotic Pets', movementLevel: 2, soundQuality: 3, visualContrast: 5 },
  ...
  { slug: 'original-siamese-cat', score: 3.65, scorePercent: 78, price: 53.90, priceCategory: 'Budget Friendly', animalCategory: 'Cat', type: 'Fluffy Companion', movementLevel: 1, soundQuality: 2, visualContrast: 3 },
  { slug: 'kamomo', score: 3.85, scorePercent: 83, price: 349.00, priceCategory: 'Premium', animalCategory: 'Robot', type: 'Ai & Robotic Pets', movementLevel: 1, soundQuality: 3, visualContrast: 2 },
