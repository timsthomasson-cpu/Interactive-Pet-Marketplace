          ...
          <table className="min-w-full text-left text-sm">
            <thead className="bg-cream-100 align-top">
              <tr>
                ...
                <th className="px-3 py-4 text-left font-semibold text-slate-900 min-w-[90px]">Reviews</th>
                <th className="px-3 py-4 text-left min-w-[110px]">
            ...
            <tbody>
              {filtered.length === 0 ? (
                <tr><td colSpan={10} className="px-5 py-10 text-center text-slate-600">No products match these filters. <button onClick={() => setFilters(ALL)} className="font-semibold text-trust-700 underline hover:text-trust-900">Clear filters</button></td></tr>
