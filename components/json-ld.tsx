...
// All JSON-LD schema utilities AND the <JsonLd> render component in one
// file. Previously these were split across json-ld.ts (builders) and
// json-ld.tsx (component), which caused a Webpack resolution issue: imports
// of "@/components/json-ld" resolved to one file but not both, leaving the
// other module's exports undefined at runtime. Single file avoids that.
